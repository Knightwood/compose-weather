...
object ThemeAndLangs {
    ...
    fun CoroutineScope.modifyThemeSeedColor(colorArgb: Int, paletteStyleIndex: Int) {
        launch(Dispatchers.IO) {
            mutableAppSettingsStateFlow.update {
    ...
    fun CoroutineScope.switchDynamicColor(enabled: Boolean = !mutableAppSettingsStateFlow.value.isDynamicColorEnabled) {
        launch(Dispatchers.IO) {
            mutableAppSettingsStateFlow.update {
