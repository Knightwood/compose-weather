...
```groovy
implementation 'com.kiylx.safframework.delegate:extras-delegate:1.1.0'
```
 ...
 *
 * @FileName:
 *          com.kiylx.safframework.delegate.activity.Demo4ExtrasDelegateActivity.java
 * @author: Tony Shen
...
```groovy
implementation 'com.kiylx.safframework.delegate:prefs-delegate:1.1.0'
```
 ...
 *
 * @FileName:
 *          com.kiylx.safframework.delegate.prefs.PrefsHelper.java
 * @author: Tony Shen
 ...
 *
 * @FileName:
 *          com.kiylx.safframework.delegate.prefs.EncryptPrefsHelper.java
 * @author: Tony Shen
...
```groovy
implementation 'com.kiylx.safframework.delegate:prefs-fastjson-delegate:1.1.0'
```
...
```groovy
implementation 'com.kiylx.safframework.delegate:prefs-gson-delegate:1.1.0'
```
 ...
 *
 * @FileName:
 *          com.kiylx.safframework.delegate.prefs.ObjectPrefsHelper.java
 * @author: Tony Shen
