package com.kiylx.libx.tools.sonser.gps.convert.egm96;

import com.kiylx.libx.tools.sonser.gps.convert.Location;
 ...
 * <p>
 * 调用Geoid.init(inputstream)初始化，然后使用转换方法getOffset(new Location(latitude, longitude))获取高程异常
 * *
 */
public class Geoid {
